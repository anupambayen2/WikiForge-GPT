"""
STAGE_1 - Step 1: Train 16,000 Token Tokenizer
===============================================================================
Time: ~15-25 minutes
Expected output: tokenizer_vocab16000.json
"""
...
def train_tokenizer():
    print("\n" + "="*80)
    print("STAGE_1 - TRAIN 16,000 TOKENIZER")
    print("="*80 + "\n")
    ...
    print(f"\n📍 Next step: python scripts/stage_1/step2_tokenize_dataset.py\n")
