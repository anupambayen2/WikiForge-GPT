"""
STAGE_1 - Step 2: Tokenize Dataset (MEMORY-EFFICIENT - FIXED)
===============================================================================
Tokenize dataset using EXACT SAME approach as Stage 0 (PROVEN TO WORK!)
Processes in chunks and saves incrementally.
"""
...
class MemoryEfficientTokenizer:
    ...
    Uses same proven approach as Stage 0!
    """
    ...
    def __init__(
        ...
        self.output_dir = PATHS.TRAINING_DATA / f"stage_1_vocab{vocab_size}"
    ...
    def run(self):
        ...
        print("\n" + "="*80)
        print("🚀 STAGE 1 Dataset Tokenization (Memory-Efficient)")
        print("="*80)
        ...
        print(f"\n📍 Next step: python scripts/stage_1/step3_train_model.py")
...
def main():
    ...
    print("\n🎯 Tokenizing for Stage 1 (45M Model)")
    print("   Vocab: 16K | Sequence Length: 256 tokens")
