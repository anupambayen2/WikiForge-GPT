# STAGE_2 - 125M Parameters

## Overview
- **Parameters**: 125M
- **Architecture**: 12 layers, 12 heads, 768 d_model
...
python scripts/stage_2/step1_train_tokenizer.py

# Step 2: Tokenize dataset (~45-75 min)
python scripts/stage_2/step2_tokenize_dataset.py

# Step 3: Train model (48 hours)
python scripts/stage_2/step3_train_model.py
```
...
- **Loss**: Should decrease from ~70 → ~2.0
...
Model checkpoints:
```
E:/WikiForge-GPT/models/checkpoints/stage_2/checkpoints/
