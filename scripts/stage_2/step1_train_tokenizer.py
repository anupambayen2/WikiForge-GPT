"""
STAGE_2 - Step 1: Train 32,000 Token Tokenizer
===============================================================================
Time: ~15-25 minutes
Expected output: tokenizer_vocab32000.json
"""
...
def train_tokenizer():
    print("\n" + "="*80)
    print("STAGE_2 - TRAIN 32,000 TOKENIZER")
    print("="*80 + "\n")
    ...
    print(f"\n📍 Next step: python scripts/stage_2/step2_tokenize_dataset.py\n")
