"""
STAGE_2 - Step 3: Train 125M Model
===============================================================================
...
def train_model():
    print("\n" + "="*80)
    print("STAGE_2 - TRAIN 125M MODEL")
    print("="*80 + "\n")
    ...
    print(f"  Model: 125M parameters")
    print(f"  Architecture: 12 layers, 12 heads, 768 d_model")
    ...
    # Load data
    data_dir = PATHS.TRAINING_DATA / "stage_2_vocab32000"
    ...
    # Setup directories
    checkpoint_dir = PATHS.CHECKPOINTS / "stage_2" / "checkpoints"
    checkpoint_dir.mkdir(parents=True, exist_ok=True)
    
    log_dir = PATHS.LOGS / "training"
    log_dir.mkdir(parents=True, exist_ok=True)
    log_file = log_dir / "stage_2_training_log.jsonl"
